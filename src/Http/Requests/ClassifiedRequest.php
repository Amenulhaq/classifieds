...
namespace Laraclass\Classifieds\Http\Requests;
...
class ClassifiedRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('classified');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access classified module,
            return $this->user()->can('view', config('laraclass.classifieds.classified.model.model'));
        }
