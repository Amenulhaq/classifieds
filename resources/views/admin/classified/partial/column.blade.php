        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    ->checkboxes(trans('classifieds::classified.cloumns'))
                    ->inline()
                    ->raw()!!}
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'classifieds.classified.column');
        formData.append('package', 'Classifieds');
        formData.append('module', 'Classified');
