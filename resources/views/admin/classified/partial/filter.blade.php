<div class="btn-group classifieds-classified">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[parentcategory_id]" class="col-sm-2 control-label">
                                        {!! trans('classifieds::classified.label.parentcategory_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[parentcategory_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[area_id]" class="col-sm-2 control-label">
                                        {!! trans('classifieds::classified.label.area_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[area_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".classifieds-classified .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/classifieds.classified.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".classifieds-classified .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.classifieds-classified .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'classifieds.classified.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#classifieds-classified-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#classifieds-classified-list .btn-reset-filter').css('display', 'none');
